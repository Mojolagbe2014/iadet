...
$thisPage->title = StringManipulator::trimStringToFullWord(62, stripslashes(strip_tags("Edit Profile - International Academy of Dental Education and Training (IADET)")));
$thisPage->description = StringManipulator::trimStringToFullWord(150, stripslashes(strip_tags("Edit user profile or details.")));
$thisPage->keywords = "profile, update, edit";
...
<body class="page page-id-107 page-template-default custom-background woocommerce-account woocommerce-page tribe-theme-Guru page-template-page-php no-js">
        ...
        <div id="wrapper">
            ...
            <section class="breadcrumb-wrapper">
                    <div class="container">
                        ...
                        <a href="profile">Profile</a><span class="default" >  </span><h4>Edit Profile</h4>
                        </div>				  
                    </div>                      
            </section>
                        ...
                        <section id="main-course" class="course-container">
                            <article class="course post post-2541 type-course status-publish has-post-thumbnail hentry course-category-food">
                                <div class="woocommerce">
                                    <h2>Edit Profile</h2>
                                    <form action="REST/user-profile-update.php" method="post" class="login" id="updateUserProfile" name="updateUserProfile">
                                        <p class="form-row form-row-wide"> <input  id="firstName" name="firstName" placeholder="First Name" type="text" value="<?php echo $userObj->firstName; ?>" aria-required="true"> </p>
                                        <p class="form-row form-row-wide"> <input  id="lastName" name="lastName" placeholder="Last Name" type="text" value="<?php echo $userObj->lastName; ?>" aria-required="true"> </p>
                                        <p class="form-row form-row-wide"><input  id="phone" name="phone" placeholder="Phone Number" type="text" value="<?php echo $userObj->phone; ?>" aria-required="true"></p>
                                        <p class="form-row form-row-wide"><input  id="address" name="address" placeholder="Address" type="text" value="<?php echo $userObj->address; ?>" aria-required="true"></p>
                                        <p class="form-row">
                                            <input type="hidden" id="id" name="id" value="<?php echo $userObj->id; ?>" />
                                            <input type="submit" class="button" name="change-password" value="Update Profile" /> 
                                            <br/>
                                        </p>
                                    </form>
                                </div>
    ...
    <script>
        ...
        jQuery(document).ready(function($){
            $('form#updateUserProfile').submit(function (e) {
                e.stopPropagation(); 
                e.preventDefault(); 
                    ...
                    success : function(data, status) {
                        if(data.status != null && data.status !=1) { 
                            ...
                            swal({
                                ...
                                type: 'success',
                                text: data.msg+ "<br/><span style='color:darkblue;'>The changed parameters will take effect after you re-login.</span><br/> Do you want to logout now?",
                                ...
                                function(isConfirm){ if (isConfirm) { 
                                    $.ajax({
                                        url: "REST/user-logout.php",
                                        success : function(data, status) {
                                            swal({
                                                title: "Logout Successful !!!",
                                                text: data.msg +"<br/> <em style='color:red'>Window will reload in 2seconds if no action is taken.</em>",
                                                timer: 3000,
                                                html:true,

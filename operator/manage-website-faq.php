...
<head>
    ...
    <title>Manage Main Website FAQ Page - AIDET</title>
...
<body>
                    ...
                    <div class="content">
                        <div class="module">
                            <div class="module-head">
                                <h3>Page Manager: FAQs </h3>
                            </div>
                            <div class="module-body">
                                <form class="form-horizontal row-fluid" id="ManageWebsiteFaq" name="ManageWebsiteFaq" action="../REST/manage-website-faq.php" enctype="multipart/form-data">
                                    ...
                                    <div class="control-group">
                                        <div class="controls">
                                            <input type="hidden" name="updateThisFaq" id="updateThisFaq" value="updateThisFaq"/>
                                            <button type="submit" name="updateContent" id="updateContent" class="btn btn-danger">Update FAQ Page</button> &nbsp; &nbsp;
    ...
    <script src="scripts/manage-website-faq.js" type="text/javascript"></script>
</body>
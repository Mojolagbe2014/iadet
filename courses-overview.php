...
$thisPage->title = StringManipulator::trimStringToFullWord(62, stripslashes(strip_tags("Courses Overview - International Academy of Dental Education and Training (IADET)")));
$thisPage->description = StringManipulator::trimStringToFullWord(150, stripslashes(strip_tags("All available ecourses, online courses, dental courses")));
	...
	<!-- wrapper div starts here -->
        <div id="wrapper">
            ...
            <section class="breadcrumb-wrapper">
                ...
                <div class="breadcrumb"><a href="index">Home</a><span class="default" >  </span><h4>Courses Overview</h4></div>				  </div>                      
            </section>
                    ...
                    <section class="content-full-width" id="primary">
                        <article id="post-102" class="post-102 page type-page status-publish hentry"> 
                                ...
                                <div class="fullwidth-bg">	
                                    <div class="container">
                                        ...
                                        <div style="text-align: left;">
                                            <h3 style="color: #000000;">All Courses</h3>
                                        </div>
                            ...
                            <blockquote class=' alignright blue' id="blockquote" style="color:#000000;">
                                <q>We offer a large selection of courses across dental study areas, with the right balance of practical knowledge and academic excellence and a wide range of study options.</q> 
                            </blockquote>
                            <section id="main-course" class="course-container">
                                <?php 
                                foreach($courseObj->fetchRaw("*", " visible = 1 AND category > 0  ", " RAND() LIMIT 100 ") as $course){
                            ...
                            <div class='fullwidth-section  '  style="color:#ffffff;background-repeat:no-repeat;"><div class="fullwidth-bg">	<div class="container"><script type="text/javascript">var lsjQuery = jQuery;</script><script type="text/javascript"> lsjQuery(document).ready(function() { if(typeof lsjQuery.fn.layerSlider == "undefined") { lsShowNotice('layerslider_7','jquery'); } else { lsjQuery("#layerslider_7").layerSlider({responsiveUnder: 960, layersContainer: 960, autoStart: false, pauseOnHover: false, skinsPath: 'plugins/LayerSlider/static/skins/'}) } }); </script><div id="layerslider_7" class="ls-wp-container" style="width:960px;height:460px;margin:0 auto;margin-bottom: 0px;"><div class="ls-slide" data-ls=" transition2d: all;"><img src="plugins/LayerSlider/static/img/blank.gif" data-src="uploads/2014/11/macbook-air.png" class="ls-bg" alt="Slide background" /><div class="ls-l" style="top:68px;left:244px;white-space: nowrap;" data-ls="offsetxin:0;offsetxout:0;"><iframe width="471" height="290" src="//www.youtube.com/embed/68p2sw5oaLY?feature=player_detailpage&amp;autoplay=0" frameborder="0" allowfullscreen></iframe> </div></div></div>	</div></div></div>

...
$thisPage->title = StringManipulator::trimStringToFullWord(62, stripslashes(strip_tags("Create an Account - International Academy of Dental Education and Training (IADET)")));
$thisPage->description = StringManipulator::trimStringToFullWord(150, stripslashes(strip_tags("Join learners and professionals on IADET elearning platform.")));
$thisPage->keywords = "register, create, account, learners";
        ...
        <div id="wrapper">
            ...
            <section class="breadcrumb-wrapper">
                <div class="container">
                    ...
                    <a href="index">Home</a><span class="default" >  </span><h4>Register</h4>
                    </div>				  
                </div>                      
            </section>
            ...
            <div class="content">
                <div class="container">
                    <section class="content-full-width" id="primary">
                        <article id="post-0" class="bp_register type-bp_register post-0 status-publish hentry">
                            <div id="buddypress">
                                <div class="page" id="register-page">
                                    <form action="REST/add-user-captcha.php" name="signup_form" id="signup_form" class="standard-form" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="register-section" id="basic-details-section">
                                            ...
                                            <input type="text" name="userName" id="userName" placeholder="Username (It must be lowercase)" value=""  autocomplete="off" autocapitalize="none"/>
                                            <input type="email" name="email" placeholder="Email Address" id="email" value="" />
                                            <p class="form-row form-row-wide"><span class="required" style="font-size:10px; line-height:1.0">Password must contain at least 8 characters including at least 1 digit, at least 1 uppercase letter, at least 1 non-alphanumeric character</span></p>
                                            <input type="passWord" name="passWord" placeholder="Password" id="passWord" value="" class="password-entry"  spellcheck="false" autocomplete="off"/>
                                            <div id="pass-strength-result"></div>
                                            
                                            <input type="password" name="passWord1" id="passWord1" placeholder="Confirm Password" value="" class="password-entry-confirm"  spellcheck="false" autocomplete="off"/>
                                        </div><!-- #basic-details-section -->
                                        <div class="register-section" id="profile-details-section">
                                            <h4>Profile Details</h4>
                                            <div class="editfield field_1 field_name required-field visibility-public field_type_textbox">
                                                <input  id="firstName" name="firstName" placeholder="First Name" type="text" value="" aria-required="true">
                                                <input  id="lastName" name="lastName" placeholder="Last Name" type="text" value="" aria-required="true">
                                                <input  id="phone" name="phone" placeholder="Phone Number" type="text" value="" aria-required="true">
                                                <input  id="address" name="address" placeholder="Address" type="text" value="" aria-required="true">
                                        ...
                                        <div style="float: left; clear: left; width: 48%; margin: 12px 0;" class="security-question-section">
                                            <h4>Prove that you are not a robot: 3 + 2 = ?</h4>
                                            <input type="text" name="robot" id="robot" value="" />
<!--                                            <div class="g-recaptcha" data-sitekey="6Ld_MQ0TAAAAAIOjuBaM0tkLlS47niEh9_zkgjid"></div>-->
                                        </div>
                                        <input type="hidden" id="ct_checkjs_register_form_f5deaeeae1538fb6c45901d524ee2f98" name="ct_checkjs_register_form" value="0" /><script type="text/javascript">setTimeout(function(){var ct_input_name = 'ct_checkjs_register_form_f5deaeeae1538fb6c45901d524ee2f98';var ct_input_value = document.getElementById(ct_input_name).value;document.getElementById(ct_input_name).value = document.getElementById(ct_input_name).value.replace(ct_input_value, '1213645260'); }, 1000);</script>
                                        <div class="submit">
                                            <input type="submit" name="signup_submit" id="signup_submit" value="Sign Up" />
                                        </div>
                                        <input type="hidden" id="addNewUser" name="addNewUser" value="addNewUser" />
                                    </form>
                                </div>
                            </div><!-- #buddypress -->
                    ...
                    success : function(data, status) {
                        if(data.status != null && data.status !=1) { 
                            ...
                            swal({
                                ...
                                type: 'success',
                                text: data.msg+ "<br/> Do you want to login now?",
                                ...
                                function(isConfirm){ if (isConfirm) { window.location = 'login'; } 
                            });
                        }
                        else {
                            swal({

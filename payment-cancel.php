...
$thisPage->title = StringManipulator::trimStringToFullWord(62, stripslashes(strip_tags("Course Purchase Cancelled - International Academy of Dental Education and Training (IADET)")));
$thisPage->description = StringManipulator::trimStringToFullWord(150, stripslashes(strip_tags("The course transaction process cancelled by the user.")));
$thisPage->keywords = "cancel, course, purchase";
	...
	<!-- wrapper div starts here -->
        <div id="wrapper">
            ...
            <section class="breadcrumb-wrapper">
                <div class="container">
                    <h1>Course Payment Cancelled</h1>
                    <div class="breadcrumb">
                        <a href="index">Home</a><span class="default" >  </span>
                        <a href="courses-overview">Courses Overview</a><span class="default" >  </span>
                ...
                <div class="container">
                    <section class="content-full-width" id="primary">
                        <div class="error-404">
                            <br/><br/>
                            <div class="error">
                                <h1>Course Purchase Process Terminated</h1>
                            </div>

...
if(filter_input(INPUT_POST, "loginstuff")!=NULL){
    ...
    if(count($errorArr) < 1)   {
        ...
        if($logingInAdmin->status === 1){
            $_SESSION['IADETLoggedInAdmin'] = true; $_SESSION['IADETAdminName'] = $logingInAdmin->info[0]->userName;
            $_SESSION['IADETadminId'] = $logingInAdmin->info[0]->id; $_SESSION['IADETadminEmail'] = $logingInAdmin->info[0]->email;

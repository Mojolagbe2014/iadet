...
$thisPage->title = StringManipulator::trimStringToFullWord(62, stripslashes(strip_tags(WebsiteAbout::getSingle($dbObj, 'title', 1))));
$thisPage->description = StringManipulator::trimStringToFullWord(150, stripslashes(strip_tags(WebsiteAbout::getSingle($dbObj, 'description', 1))));
$thisPage->keywords = WebsiteAbout::getSingle($dbObj, 'keywords', 1);
...
<head>
    ...
    <script type='text/javascript' src='plugins/buddypress/bp-core/js/confirm.mindc8c.js?ver=2.2'></script>
    <script type='text/javascript' src='plugins/buddypress/bp-core/js/widget-members.mindc8c.js?ver=2.2'></script>
    <script type='text/javascript' src='plugins/buddypress/bp-core/js/jquery-query.mindc8c.js?ver=2.2'></script>
    <script type='text/javascript' src='plugins/buddypress/bp-core/js/jquery-cookie.mindc8c.js?ver=2.2'></script>
    <script type='text/javascript' src='plugins/buddypress/bp-core/deprecated/js/jquery-scroll-to.mindc8c.js?ver=2.2'></script>
    <script type='text/javascript' src='plugins/buddypress/bp-templates/bp-legacy/js/buddypressdc8c.js?ver=2.2'></script>
    <script type='text/javascript' src='plugins/photo-gallery/js/bwg_frontend2a18.js?ver=1.2.15'></script>
    <script type='text/javascript' src='plugins/photo-gallery/js/jquery.mobile2a18.js?ver=1.2.15'></script>
    <script type='text/javascript' src='plugins/photo-gallery/js/jquery.mCustomScrollbar.concat.min2a18.js?ver=1.2.15'></script>
    <script type='text/javascript' src='plugins/photo-gallery/js/jquery.fullscreen-0.4.131ec.js?ver=0.4.1'></script>
    <script type='text/javascript' src='plugins/photo-gallery/js/bwg_gallery_box2a18.js?ver=1.2.15'></script>
...
<body class="page page-id-75 page-template page-template-tpl-fullwidth-php custom-background tribe-theme-Guru no-js">
            ...
            <section class="breadcrumb-wrapper">
                <div class="container">
                    ...
                    <div class="breadcrumb">
                        <a href="index">Home</a><span class="default" >  </span><h4>About US</h4>
                    </div>				  
                </div>                      
            </section>
            ...
            <div class="content">
                <section class="content-full-width" id="primary">
                    <article id="post-75" class="post-75 page type-page status-publish hentry">
                        <div class='fullwidth-section  '  style="background-color:#fcfcfc;background-repeat:no-repeat;">
                            <div class="fullwidth-bg">	
                                <div class="container">
                                    <div class='dt-sc-hr-invisible  '></div>
                                    <div  class='column dt-sc-one-half  first'>
                                        <div class='hr-title'>
                                            <h2><?php echo WebsiteAbout::getSingle($dbObj, 'content_header', 1); ?></h2><div class='title-sep'><span></span>
                                            </div>
                                        </div>
                                        <p><?php echo WebsiteAbout::getSingle($dbObj, 'content', 1); ?></p>
                                    </div>
                                    <div  class='column dt-sc-one-half  '><img class="alignnone size-full wp-image-222" src="uploads/2014/10/about-img-new.png" alt="about-img-new" /></div>
                                    <div class='dt-sc-hr-invisible  '></div>	
                                </div>
                            </div>
                        </div>
                        <div class='fullwidth-section  '  style="background-repeat:no-repeat;background-position:left top;">
                            <div class="fullwidth-bg">	
                                <div class="container">
                                    <div class='dt-sc-hr-invisible  '></div>
                                    <div class='hr-title'><h2>Our Team</h2><div class='title-sep'><span></span></div></div>
                                    <?php 
                                    $teamObj = new Tutor($dbObj); $counter = 1;
                                    foreach ($teamObj->fetchRaw("*", " visible =1 ") as $tutorObj){
                                        $firstMember ="";
                                        if($counter===1){ $firstMember = 'first';}
                                    ?>
                                    <div class="column dt-sc-one-fourth <?php echo $firstMember; ?>">
                                        <div class="dt-sc-team">
                                            ...
                                            <div class="dt-sc-entry-title">
                                                <h2><a href="tutor-details?ajax=true&amp;action=dt_theme_team_member&amp;post_id=<?php echo $tutorObj['id']; ?>&amp;nonce=6cdafbe8c3" data-gal="prettyPhoto[pp_gal]"><?php echo $tutorObj['name']; ?></a></h2>
                                                <h6><a href="#"><?php echo $tutorObj['qualification']; ?></a></h6>
                                                <h6><a href="tutor-details?ajax=true&amp;action=dt_theme_team_member&amp;post_id=<?php echo $tutorObj['id']; ?>&amp;nonce=6cdafbe8c3" data-gal="prettyPhoto[pp_gal]">More Description...</a></h6>
                                            </div>
                                        </div>
                                    </div>
                                    <?php $counter++; }  ?>
                        ...
                        <div class='fullwidth-section  '  style="background-color:#fafafa;background-repeat:no-repeat;background-position:left top;">
                            <div class="fullwidth-bg">	
                                <div class="container"><div class='dt-sc-hr-invisible-medium  '></div>
                                    ...
                                    <a href='services'  class='dt-sc-button  small  ' >Read More</a>
                                    </div>	
                                </div>
                            </div>
                        </div>

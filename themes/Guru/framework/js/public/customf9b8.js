...
jQuery(document).ready(function($){
	...
	$("select").each(function(){
        ...
        if (localStorage.IADETRememberMe !=null && localStorage.IADETRememberMe != '') {
            $('form#loginForm #email').val(localStorage.IADETRememberMeuserName);
            $('form#loginForm #passWord').val(localStorage.IADETRememberMepassWord);
            $('form#loginForm #rememberme').attr('checked','checked');
        } 

        $('form#loginForm').submit(function() {
            if ($('form#loginForm #rememberme').is(':checked')) {
                localStorage.IADETRememberMeuserName = $('form#loginForm #email').val();
                localStorage.IADETRememberMepassWord = $('form#loginForm #passWord').val();

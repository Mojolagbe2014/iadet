...
$thisPage->title = StringManipulator::trimStringToFullWord(62, stripslashes(strip_tags("My Courses - International Academy of Dental Education and Training (IADET)")));
$thisPage->description = StringManipulator::trimStringToFullWord(150, stripslashes(strip_tags("All my purchased ecourses, online courses, dental courses")));
	...
	<!-- wrapper div starts here -->
        <div id="wrapper">
            ...
            <section class="breadcrumb-wrapper">
                <div class="container">
                    <h1>My Courses</h1>
                <div class="breadcrumb"><a href="index">Home</a><span class="default" >  </span> <a href="profile">Profile</a><span class="default" >  </span><h4>My Courses</h4></div>				  </div>                      
            </section>
                    ...
                    <section class="content-full-width" id="primary">
                        <article id="post-102" class="post-102 page type-page status-publish hentry"> 
                                ...
                                <div class="fullwidth-bg">	
                                    <div class="container">
                                        ...
                                        <div style="text-align: left;">
                                            <h3 style="color: #000000;">All Purchased Courses</h3>
                                        </div>
                            ...
                            <section id="main-course" class="course-container">
                                ...
                                foreach ($purchaseRecord->fetchRaw("*", " user = $userObj->id ") as $purchasedCourse) {
                                  if($purchasedCourse['item_type'] == 'course'){
                                    foreach ($courseObj->fetchRaw("*", " id = ".$purchasedCourse['course']) as $course) {
                                ...
                                <article class="post-313 course type-course status-publish has-post-thumbnail hentry post">
                                    <a href="<?php echo MOODLE_URL.'course/view.php?id='.$course['id']; ?>" class="ecourse-zone" title="<?php echo $course['fullname']; ?>">
                                    ...
                                    <header>
                                        <h2><a href="<?php echo MOODLE_URL.'course/view.php?id='.$course['id']; ?>" class="ecourse-zone" title="<?php echo $course['fullname']; ?>"><?php echo $course['fullname']; ?></a></h2>
                                    </header>
                                    <section class="entry">
                                        <p class="sensei-course-meta">
                                            ...
                                            <span class="course-category">in <a href="<?php echo MOODLE_URL.'course/view.php?id='.$course['id']; ?>" class="ecourse-zone" rel="tag"><?php echo $course['shortname']; ?></a></span>
                                            <span class="course-price"><span class="amount">&pound;<?php echo $course['amount']; ?></span></span>
                                        </p>
                                        <p class="course-excerpt"></p>
                                    </section>
                                </article>
                                <?php }} if($purchasedCourse['item_type'] == 'category' && $purchasedCourse['mode'] !='installment'){ 
                                    foreach($courseObj->fetchByCategory($purchasedCourse['course'], MOODLE_DB_PREFIX."course_categories") as $course){
                                        $contextId = Context::getContextId($dbMoObj, MOODLE_DB_PREFIX, CONTEXT_COURSE, $course['id']);
                                        $course['image'] = MOODLE_URL.'pluginfile.php/'.$contextId.'/course/overviewfiles/'.Files::getCourseImage($dbMoObj, MOODLE_DB_PREFIX, $contextId);
                                        $course['amount'] = Course::getSingle($dbObj, '', 'amount', " name = '".$course['fullname']."'");
                                ?>
                                ...
                                <?php }}} ?>
                                <?php 
                                foreach ($purchaseRecord->fetchRaw("*", " user = $userObj->id GROUP BY course ") as $purchasedCourse) {
                                  if($purchasedCourse['item_type'] == 'category' && $purchasedCourse['mode'] =='installment'){
                                    foreach($courseObj->fetchByCategory($purchasedCourse['course'], MOODLE_DB_PREFIX."course_categories") as $course){
                                        $contextId = Context::getContextId($dbMoObj, MOODLE_DB_PREFIX, CONTEXT_COURSE, $course['id']);
                                        $course['image'] = MOODLE_URL.'pluginfile.php/'.$contextId.'/course/overviewfiles/'.Files::getCourseImage($dbMoObj, MOODLE_DB_PREFIX, $contextId);
                                        $course['amount'] = Course::getSingle($dbObj, '', 'amount', " name = '".$course['fullname']."'");
